...
public class WorldPanel extends JPanel {
    ...
    public WorldPanel(GamePanel gamePanel, KeyHandler keyHandler, Player player) {
        ...
        createNPC(9, 11, 4, "circle", "Vagrant", Type.WATER, new ElectricGauntlet(), false);
        createNPC(12, 14, 6, "scared", "Archer", Type.GROUND, new GroundSpear(), false);
        createNPC(14, 4, 3, "left-right", "Magician", Type.WATER, new IceSword(), false);
        createNPC(18, 1, 4, "scared", "Magician", Type.WATER, new IceSword(), false);
        createNPC(22, 14, 5, "scared", "Warrior", Type.FIRE, new GroundSpear(), false);
        createNPC(27, 11, 10, "fast-pursuer", "Warrior", Type.FIRE, new ElectricGauntlet(), false);
        createNPC(36, 7, 4, "left-right", "Archer", Type.ELECTRICITY, new IceSword(), false);

        //MERCHANT
        createNPC(18, 9, 3, "", "Vagrant", null, new IceSword(), true);
    ...
    private void createNPC(int x, int y, int speed, String behavior, String className, Type type, Weapon weapon, boolean isMerchant) {
        ...
        if(isMerchant){
            ...
            npcExperience += 16;
            npc.fighter = new Warrior(className, type, Math.max(100,new Random().nextInt((int) Math.pow(npcExperience, 2))));
